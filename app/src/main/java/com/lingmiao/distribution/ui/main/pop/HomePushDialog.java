...
public class HomePushDialog extends Dialog {
    ...
    private String mId = "";
    private DispatchOrderRecordBean mData;
    private String mContent;
    private String mCancle;
    private String mSure;
    private String mOrderNum;

    public HomePushDialog(Context context, DialogPushConfirmClick lisetner, DispatchOrderRecordBean data) {
        super(context);
        this.mData = data;
        this.mId = data.getId();
...
//            dismiss();
    ...
    private void refreshView() {
        ...
        if (mData.getOrderList() != null && mData.getOrderList().size() != 0) {
            DispatchOrderItemBean firstOrder = mData.getFirstOrder();

            //订单号
            mOrderNum = firstOrder.getOrderNo();
            viewBinding.mOrderNum.setText("订单号：" + firstOrder.getOrderNo());
            //状态
            viewBinding.mState.setText(getDispatchName(mData.getDispatchStatus()));
            //时效
            ...
            //商品信息
            viewBinding.mGood.setText(mData.getGoodsInfo());
            //备注
