package com.fisheagle.mkt.business.photo
...
import com.lingmiao.distribution.ui.photo.GlideEngine
...
class PhotoHelper {
    ...
    companion object {
        ...
        fun previewAlbum(activity: Activity, position: Int, list: List<UploadDataBean>?) {
        ...
        fun previewImage(activity: Activity, imageUrl : String?) {
            val newList = mutableListOf<LocalMedia>()
            var image = UploadDataBean("0", imageUrl, imageUrl);
