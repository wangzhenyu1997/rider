...
import com.lingmiao.distribution.databinding.ActivityFailedToSignInTwoBinding;
 ...
 * niuxinyu
 */
public class FailedToSignInTwoActivity extends ActivitySupport implements View.OnClickListener {

    private ActivityFailedToSignInTwoBinding viewBinding;
    ...
    protected void setCreateView(@Nullable Bundle savedInstanceState) {
        viewBinding = ActivityFailedToSignInTwoBinding.inflate(LayoutInflater.from(this));
    ...
    private void submit() {
        ...
        mMap.put("signFailType", mRefuseAcceptType);
        ...
        OkHttpUtils.postAync(Constant.AppSignFail, new Gson().toJson(mMap), new HttpCallback<BasicBean>(context, getProgressDialog()) {
            @Override
