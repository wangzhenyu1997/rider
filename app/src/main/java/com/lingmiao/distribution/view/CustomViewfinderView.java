...
public class CustomViewfinderView extends ViewfinderView {
     ...
     * 线性梯度各个位置对应的颜色值
     */
    public int[] mScanLineColor = new int[]{0x00FFFFFF, Color.GREEN, 0x00FFFFFF};
    ...
    public void onDraw(Canvas canvas) {
        refreshSizes();
        if (framingRect == null || cameraPreview == null) {
            return;
        }

        Rect frame = framingRect;
        Rect previewFrame = cameraPreview.getFramingRect();
