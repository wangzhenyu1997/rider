 ...
 * 修改者，修改日期，修改内容
 */
public class LayoutTopTwoView extends FrameLayout {
    ...
    public LayoutTopTwoView(@NonNull Context context) {
        this(context, null);
    }

    public LayoutTopTwoView(@NonNull Context context, @androidx.annotation.Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public LayoutTopTwoView(@NonNull Context context, @androidx.annotation.Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void setTopView() {
        View view = mInflater.inflate(R.layout.layout_top_two_title, this, false);
    ...
    public static class TopCallback {
