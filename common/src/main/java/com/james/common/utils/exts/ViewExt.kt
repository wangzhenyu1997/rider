...
// --------------------- drawRight  ---------------------
inline fun TextView.drawRight(drawable : Drawable?) {
    return this.setCompoundDrawables(null, null, drawable, null);
}

inline fun RadioButton.drawRight(drawable : Drawable?) {
    return this.setCompoundDrawables(null, null, drawable, null);
}