package com.github.nrecyclerview.dirview;
...
import com.github.nrecyclerview.progressindicator.AVLoadingIndicatorView;
...
public class LoadingMoreFooter extends LinearLayout {
    ...
    public void initView() {
        ...
        layoutParams.setMargins((int) getResources().getDimension(R.dimen.textandiconmargin), (int) getResources().getDimension(R.dimen.textandfootmargin), 0, (int) getResources().getDimension(R.dimen.textandfootmargin));
